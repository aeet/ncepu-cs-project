...
func (cu *CampusUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, CampusMutation](ctx, cu.sqlSave, cu.mutation, cu.hooks)
}
...
func (cu *CampusUpdate) sqlSave(ctx context.Context) (n int, err error) {
...
func (cuo *CampusUpdateOne) Save(ctx context.Context) (*Campus, error) {
	return withHooks[*Campus, CampusMutation](ctx, cuo.sqlSave, cuo.mutation, cuo.hooks)
}
...
func (cuo *CampusUpdateOne) sqlSave(ctx context.Context) (_node *Campus, err error) {
	_spec := sqlgraph.NewUpdateSpec(campus.Table, campus.Columns, sqlgraph.NewFieldSpec(campus.FieldID, field.TypeInt))
	id, ok := cuo.mutation.ID()
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`domain: missing "Campus.id" for update`)}
	}
	...
	_node = &Campus{config: cuo.config}
