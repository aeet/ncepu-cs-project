...
func (ad *AuthorizationDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, AuthorizationMutation](ctx, ad.sqlExec, ad.mutation, ad.hooks)
}
...
func (ad *AuthorizationDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(authorization.Table, sqlgraph.NewFieldSpec(authorization.FieldID, field.TypeInt))
