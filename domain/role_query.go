...
func (rq *RoleQuery) loadResource(ctx context.Context, query *ResourceQuery, nodes []*Role, init func(*Role), assign func(*Role, *Resource)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(resource.FieldID), joinT.C(role.ResourcePrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(role.ResourcePrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.ResourcePrimaryKey[0]))
