...
func (rc *RoleCreate) check() error {
	if _, ok := rc.mutation.RoleName(); !ok {
		return &ValidationError{Name: "role_name", err: errors.New(`domain: missing required field "Role.role_name"`)}
	}
	...
	if _, ok := rc.mutation.RoleValue(); !ok {
		return &ValidationError{Name: "role_value", err: errors.New(`domain: missing required field "Role.role_value"`)}
	}
	if v, ok := rc.mutation.RoleValue(); ok {
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.RoleValue(); ok {
		_spec.SetField(role.FieldRoleValue, field.TypeString, value)
		_node.RoleValue = value
	}
